...
#
#     PHX_SERVER=true bin/vrchat_ytsearch start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :vrchat_ytsearch, VrchatYtsearchWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  config :vrchat_ytsearch, VrchatYtsearch.Repo,
    database: System.get_env("DATABASE_PATH") || "/data/vrchat_ytsearch.db",
